...
const Home = () => {
  ...
  useEffect(() => {
    const filteredTrendingProducts = products.filter(item => item.category === 'ball');
    const filteredBestSalesProducts = products.filter(item => item.category === 'Bat');
    const filteredMobileProducts = products.filter(item => item.category === 'accessories');
    const filteredWirelessProducts = products.filter(item => item.category === 'supplement');
    const filteredPopularProducts = products.filter(item => item.category === 'shoe');
